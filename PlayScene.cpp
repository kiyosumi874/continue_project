...
/// それ以外は自分のポインタを返す
/// </returns>
SceneBase* PlayScene::Update(float _deltaTime, int& _hiScore)
{
	switch (mGameMode)
	{
...
/// 音楽
/// </summary>
void PlayScene::Sound(float _deltaTime)
{
...
void PlayScene::GameModeFadeInBehavior(float _deltaTime)
{
...
void PlayScene::GameModeCameraMoveBehavior(float _deltaTime)
{
...
void PlayScene::GameModeWaitBehavior(float _deltaTime)
{
...
void PlayScene::GameModeGayaBehavior(float _deltaTime)
{
...
void PlayScene::GameModeFadeOutBehavior(float _deltaTime)
{
	mAlphaPal += mFadeSpeed;
}

void PlayScene::LoadEX(int& _tmp, short& _count, int _handle)
{
